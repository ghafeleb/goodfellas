...
class BaseMetricLossFunction(
    ...
    def compute_loss(self, embeddings, labels, parties, indices_tuple=None):
        """
        This has to be implemented and is what actually computes the loss.
        """
        raise NotImplementedError

    def forward(self, embeddings, labels, parties, indices_tuple=None):
        """
        Args:
        ...
        loss_dict = self.compute_loss(embeddings, labels, indices_tuple=indices_tuple, parties=parties)
