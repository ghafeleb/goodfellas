...
def get_all_pairs_indices(labels, parties, ref_labels=None):
    """
    ...
    labels1_class = parties.unsqueeze(1)
    labels2_class = parties.unsqueeze(0)
    matches_class = (labels1_class == labels2_class).byte()
    diffs_class = matches_class ^ 1
    '''end of our code'''
    ...
    diffs = matches ^ 1
    # print('~~~~~~~~~~~~~~`diffs device:', diffs.device)
    # print('~~~~~~~~~~~~~~~diffs_classes device:', diffs_class.device)
    diffs = diffs * diffs_class
...
def convert_to_pairs(indices_tuple, labels, parties):
    """
    ...
    if indices_tuple is None:
        return get_all_pairs_indices(labels, parties=parties)
